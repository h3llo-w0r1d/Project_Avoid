...
export const CHARACTERS = [
  ...
  },
  {
    ...
    skin: 'ornate',
    // 몸매는 만드라고라 계열 그대로다. 이 캐릭터의 개성은 실루엣이 아니라
    // 몸에 두른 것에서 나오므로, 몸을 바꾸면 오히려 계보가 끊긴다.
    profile: [
      [0.000, 0.000], [0.055, 0.150], [0.140, 0.265], [0.260, 0.360],
      [0.400, 0.440], [0.560, 0.500], [0.730, 0.542], [0.910, 0.566],
      [1.090, 0.575], [1.270, 0.564], [1.430, 0.528], [1.570, 0.468],
      [1.680, 0.380], [1.760, 0.258], [1.805, 0.120], [1.820, 0.000]
    ],
    face: {
      sclera: 0xfffaf0,
      eye: 0x2a1a06,
