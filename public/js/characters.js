...
export const CHARACTERS = [
  ...
  },
  {
    ...
    top: { kind: 'leaves', count: 4, length: 1.4, color: '#a9d477', upright: 0.6 },
    skin: 'fiber',
    mouth: 'confused',   // 갸우뚱 의문 입
    question: true,      // 머리 옆에 "?" 를 띄운다
    // 왼 눈썹 확 올리고 오른 눈썹 내림(갸우뚱), 눈동자는 위로 굴려 어리둥절
    face: { pupil: [[0.03, 0.06], [0.015, 0.035]], brow: [0.16, -0.07] }
  },
  {
    id: 'carrot',
    wip: true,
