...
export const CHARACTERS = [
  ...
  },
  {
    ...
    // 좁아져 둥근 부리(코)로 끝난다. 좌우대칭이라 옆으로 휜 곡선은 못 내지만
    // '어깨는 넓고 아래는 좁은' 비율로 망고처럼 읽히게 한다.
    profile: [
      [0.000, 0.00], [0.050, 0.15], [0.140, 0.28], [0.280, 0.40],
      [0.440, 0.500], [0.620, 0.575], [0.800, 0.615], [0.950, 0.620],
      [1.080, 0.590], [1.200, 0.520], [1.310, 0.420], [1.410, 0.280],
      [1.480, 0.130], [1.520, 0.00]
    ],
