...
export const CHARACTERS = [
  ...
  {
    // 만드라고라(흑화) — 어둠에 물든 만드라고라. 뿌리로 갈수록 새까매지는
    // 몸통, 검은 테두리, 그리고 벌겋게 빛나는 눈. 시간으론 안 열리고
    // 코인 200개로만 산다(제일 비싼 흑막).
    id: 'dark',
    name: '만드라고라(흑화)',
    unlockAt: Infinity,
    coinCost: 200,
    previewZoom: 1.18,
    body: 0x2e2822,          // 어두운 흙빛 검정
    bodyTop: 0x453a2e,       // 위는 살짝 밝은 재빛
    bodyBottom: 0x120f0c,    // 뿌리로 갈수록 새까맣게
    outlineColor: 0x0c0a08,  // 거의 검정 테두리로 음산하게
    face: { eye: 0xff2a2a, sclera: 0x2a0d0d },  // 붉게 빛나는 눈(흑화)
    profile: [               // 만드라고라 몸매 그대로
      [0.000, 0.00], [0.005, 0.18], [0.030, 0.34], [0.100, 0.48],
      [0.220, 0.56], [0.380, 0.575], [0.560, 0.56], [0.760, 0.51],
      [0.960, 0.44], [1.140, 0.34], [1.300, 0.21], [1.410, 0.09],
    ...
    top: { kind: 'leaves', count: 5, length: 1.5, color: '#2f4a2a' }, // 짙게 물든 잎
    skin: 'fiber'
  },
  {
    id: 'carrot',
