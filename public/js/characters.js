...
export const CHARACTERS = [
  ...
  },
  {
    ...
    lumpy: 0.10,             // 더 삐뚤빼뚤 — 잘못 빚은 느낌
    bend: 0.11,              // 살짝 삐뚜름하게 — 어설픈 짝퉁
    profile: [               // 아래가 불룩하고 허리가 잘록한 '호리병' — 기본과 확 다르게
      [0.000, 0.00], [0.030, 0.28], [0.090, 0.46], [0.200, 0.575],
      [0.330, 0.60], [0.460, 0.57], [0.580, 0.47], [0.680, 0.38],
      [0.760, 0.36], [0.880, 0.40], [1.000, 0.42], [1.120, 0.38],
      [1.250, 0.28], [1.380, 0.14], [1.440, 0.00]
    ],
  ...
  },
  {
    ...
    bend: 0.16,          // 갸우뚱 기울어진 몸 — 어리둥절한 느낌
    profile: [           // 키 크고 홀쭉한 콩 실루엣 — 기본 물방울과 확 다르게
      [0.000, 0.00], [0.030, 0.20], [0.110, 0.34], [0.260, 0.43],
      [0.450, 0.46], [0.650, 0.455], [0.850, 0.44], [1.050, 0.41],
      [1.250, 0.36], [1.450, 0.27], [1.620, 0.15], [1.720, 0.06],
      [1.760, 0.00]
    ],
