...
export const CHARACTERS = [
  ...
  {
    // 왕만두라고라 — 하얗고 통통한 찐만두 위에 '빨간 여민 주름' 꼭지가 봉긋.
    // 왕만두답게 겉보기(sizeMul)를 키운다. 판정은 고정 반경이라 공정엔 무관.
    id: 'mandu',
    name: '왕만두라고라',
    unlockAt: 15,
    sizeMul: 1.16,           // 왕만두 — 겉보기만 큼직하게 (판정 반경은 그대로)
    previewZoom: 0.94,       // 커진 만큼 고르는 화면에선 살짝 물려 담는다
    body: 0xf8f2e6,          // 하얀 찐만두 반죽색
