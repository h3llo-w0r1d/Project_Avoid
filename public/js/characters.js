...
export const CHARACTERS = [
  ...
  },
  {
    ...
    profile: [
      ...
      [0.420, 0.55], [0.600, 0.54], [0.780, 0.50], [0.920, 0.42],
      [1.020, 0.30], [1.080, 0.16], [1.120, 0.06], [1.140, 0.00]
    ],
    top: { kind: 'sprout', count: 3, color: '#c9b088', length: 0.42 },
  ...
  },
  {
    ...
    skin: 'fiber',
    // 사시 + 어긋난 눈썹 = 얼빠진 짝퉁 표정
    face: { pupil: [[0.045, -0.015], [-0.04, 0.035]], brow: [0.06, -0.03] }
  },
  {
    id: 'carrot',
    wip: true,
