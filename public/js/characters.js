...
export const CHARACTERS = [
  ...
  },
  {
    ...
    unlockAt: 60,
    previewZoom: 1.15,
    body: 0xf5b81a,          // 잘 익은 망고의 황금 노랑
    bodyBottom: 0x8fbf3e,    // 아래쪽은 덜 익은 초록 (망고 특유의 그라데이션)
    profile: [               // 통통한 물방울 — 아래가 둥글고 위로 갈수록 좁아진다
      [0.000, 0.00], [0.030, 0.27], [0.110, 0.44], [0.270, 0.56],
      [0.450, 0.605], [0.620, 0.60], [0.790, 0.55], [0.960, 0.47],
      [1.130, 0.36], [1.290, 0.22], [1.410, 0.10], [1.460, 0.00]
    ],
    top: { kind: 'leaves', count: 3, length: 1.4, color: '#5aa63e', upright: 0.72 },
    skin: 'fiber'            // 아주 옅은 결만
  },
  {
    id: 'carrot',
