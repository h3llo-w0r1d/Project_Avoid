...
export const CHARACTERS = [
  ...
  },
  {
    ...
    profile: [               // 뿌리 끝은 뾰족, 위로 갈수록 불룩 — 길쭉한 산삼
      [0.000, 0.00], [0.060, 0.10], [0.160, 0.19], [0.300, 0.27],
      [0.460, 0.35], [0.640, 0.43], [0.820, 0.49], [1.000, 0.535],
      [1.160, 0.555], [1.300, 0.53], [1.420, 0.46], [1.520, 0.34],
      [1.590, 0.19], [1.630, 0.00]
    ],
    face: {
