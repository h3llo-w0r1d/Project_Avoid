...
export const CHARACTERS = [
  ...
  {
    // 보스라고라 — 검은 선글라스에 한 손엔 권총, 입엔 담배. 느와르 보스.
    // 소품(shades/hold/cigarette)은 plant.js 가 얹는다. 판정 폭은 그대로라
    // 공정성엔 영향이 없다.
    id: 'boss',
    name: '보스라고라',
    unlockAt: 45,
    ...
    top: { kind: 'leaves', count: 5, length: 1.5, color: '#5b7f3c' },  // 진한 잎
    skin: 'fiber',
    shades: true,        // 선글라스
    hold: 'gun',         // 한 손에 권총
    cigarette: true,     // 입에 담배 + 연기
    face: { brow: [-0.02, -0.02] }   // 눈썹 살짝 내려 시크하게 (선글라스 위로 살짝 보임)
  },
  {
    id: 'carrot',
    wip: true,
