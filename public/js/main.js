...
(() => {
  ...
  // 보상별 확률(합 100). 특별 3종: 코인 잭팟 5% · 가나디라고라 3% · 노래 1%(합 9%).
  // 나머지 91% 를 코인 당첨(0/5/10/20/50)에 기존 비율대로 배분.
  const WEIGHTS = [
    { coins: 0, p: 30 }, { coins: 5, p: 32 }, { coins: 10, p: 14 },
    { coins: 20, p: 10 }, { coins: 50, p: 5 },
    { jackpot: true, coins: 500, p: 5 },   // 코인 잭팟 500
