...
(() => {
  ...
  // 보상별 확률(합 100). 노래 1% · 코인 잭팟 2% · 가나디라고라 3%,
  // 코인은 값이 클수록 희귀: 꽝 42 · 5코인 20 · 10코인 15 · 20코인 10 · 50코인 7.
  // (개발자의 선물 0.1% 는 없앴고, 그만큼 꽝으로 넘겼다: 41.9 → 42)
  const WEIGHTS = [
    { coins: 0, p: 42 }, { coins: 5, p: 20 }, { coins: 10, p: 15 },
  ...
  function spin() {
    ...
    setTimeout(() => {
      ...
      // 희귀 보상(1~3%: 가나디·300코인 잭팟·노래)을 뽑으면 누적 횟수를
