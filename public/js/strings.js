...
export const STRINGS = {
  ...
  // ── 새 소식(PROMO) ──────────────────────────────────────────
  'promo.title': { ko: '만드라이더 OPEN!', en: "Mandrider OPEN!" },
  'promo.lead': { ko: '만드라고라 화분을 타고 달리는 레이싱이에요. 드리프트로 부스터를 모으고, 길을 막는 커다란 만드라고라를 피해 두 바퀴!', en: "Ride the mandragora pot and race. Drift to charge boosts, dodge the giant mandragoras blocking the road — two laps!" },
  'promo.foot': { ko: '누가 제일 빠른가? 랭킹에 「만드라이더」 가 생겼어요.', en: "Who's the fastest? There's a new 「Mandrider」 leaderboard." },
  'promo.cta': { ko: '지금 달리기', en: "Race now" },
  ...
  'rank.emptyMandrider': { ko: '아직 만드라이더를 완주한 사람이 없습니다', en: 'No one has finished Mandrider yet' },
  ...
  'rank.mineMandrider': { ko: '내 순위 {rank}위 · {lap}', en: 'My rank #{rank} · {lap}' },
  ...
  'rank.tabMandrider': { ko: '만드라이더', en: 'Mandrider' },
  ...
  'rank.noteMandrider': { ko: '두 바퀴 완주 시간 · 짧을수록 위 · 로그인한 계정만 오릅니다', en: 'Two-lap finish time · Faster is higher · Only signed-in accounts appear' },
