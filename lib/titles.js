...
export const TITLES = [
  ...
  { id: 'rookie',   name: '입문자',   icon: '', plays: 10,   color: '#a7c4ff' },
  { id: 'skilled',  name: '숙련자',   icon: '', plays: 100,  color: '#6f9dff' },
  { id: 'veteran',  name: '베테랑',   icon: '', plays: 500,  color: '#4f7bff' },
  { id: 'godwater', name: '고인물',   icon: '', plays: 1000, color: '#3b5be0' },
  // 럭키가이 — 룰렛 대박(500코인·가나디라고라·노래) 당첨 시 얻는 업적 칭호. 노랑.
  // 판수와 무관하게, 클라가 대박이 나면 서버에 수여를 요청해 계정에 새긴다.
  { id: 'luckyguy', name: '럭키가이', icon: '', achievement: true,
    cond: '룰렛 대박 당첨 시', color: '#ffcf3f' },
