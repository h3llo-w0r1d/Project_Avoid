...
export const FLOORS = [
  ...
  //    점프는 전부 25번으로 통일하고 시간만 15초부터 3초씩 늘린다. 실측으로
  //    사람들은 초당 중앙값 0.75번을 쓰므로, 25번이면 33초쯤부터 모자라기
  //    시작한다 — 앞쪽은 몸풀기, 42초 층은 아껴 써야 넘어간다.
  f(11, 'survive', { seconds: 15, jumps: 25 }),
  f(12, 'survive', { seconds: 18, jumps: 25 }),
  f(13, 'survive', { seconds: 21, jumps: 25 }),
  f(14, 'survive', { seconds: 24, jumps: 25 }),
  f(15, 'survive', { seconds: 27, jumps: 25 }),
  f(16, 'survive', { seconds: 30, jumps: 25 }),
  f(17, 'survive', { seconds: 33, jumps: 25 }),
  f(18, 'survive', { seconds: 36, jumps: 25 }),
  f(19, 'survive', { seconds: 39, jumps: 25 }),
  f(20, 'survive', { seconds: 42, jumps: 25 }),
  ...
  f(48, 'coins', { n: 14, limit: 45, jumps: 25 }),
...
export const ZONES = [
  { from: 1,  to: 10, name: '입문' },
  { from: 11, to: 20, name: '점프 배급' },
  { from: 21, to: 30, name: '물리 변형' },
  { from: 31, to: 40, name: '이동 규칙' },
  { from: 41, to: 50, name: '코인 수집' },
