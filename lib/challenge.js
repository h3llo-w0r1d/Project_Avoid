...
export const FLOORS = [
  ...
  // ── 31~40층: 물리 변형. 발밑 감각 자체가 달라진다.
  f(31, 'survive', { seconds: 30, phys: 'slip' }),
  f(32, 'survive', { seconds: 33, phys: 'slip' }),
  f(33, 'survive', { seconds: 36, phys: 'slip' }),
  f(34, 'survive', { seconds: 30, phys: 'heavy' }),
  f(35, 'survive', { seconds: 33, phys: 'heavy' }),
  f(36, 'survive', { seconds: 36, phys: 'heavy' }),
  f(37, 'survive', { seconds: 33, phys: 'fast' }),
  f(38, 'survive', { seconds: 36, phys: 'fast' }),
  f(39, 'survive', { seconds: 40, phys: 'fast' }),
  f(40, 'survive', { seconds: 40, phys: 'slipheavy' }),

  // ── 41~50층: 봇전. 먼저 죽으면 진다. 여기에 제약이 얹히기 시작한다.
  f(41, 'bot', { tier: 'rookie' }),
  f(42, 'bot', { tier: 'rookie', jumps: 25 }),
  f(43, 'bot', { tier: 'novice' }),
  f(44, 'bot', { tier: 'novice', phys: 'slip' }),
  f(45, 'bot', { tier: 'mid' }),
  f(46, 'bot', { tier: 'mid', jumps: 25 }),
  f(47, 'bot', { tier: 'expert' }),
  f(48, 'bot', { tier: 'expert', phys: 'heavy' }),
  f(49, 'bot', { tier: 'master' }),
  f(50, 'bot', { tier: 'godwater', jumps: 25 })
];
