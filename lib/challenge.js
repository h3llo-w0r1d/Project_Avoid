...
export const FLOORS = [
  ...
  // ── 31~40층: 움직임 자체가 규칙이 된다.
  f(31, 'survive', { seconds: 30, still: 1.0 }),
  f(32, 'survive', { seconds: 33, still: 1.0 }),
  f(33, 'survive', { seconds: 36, still: 0.8 }),
  f(34, 'circuit', { n: 4, limit: 60 }),
  f(35, 'circuit', { n: 5, limit: 60 }),
  f(36, 'circuit', { n: 6, limit: 65 }),
  f(37, 'survive', { seconds: 30, zone: true }),
  f(38, 'survive', { seconds: 35, zone: true }),
  f(39, 'survive', { seconds: 40, zone: true }),
  ...
  f(48, 'coins', { n: 14, still: 1.0 }),
  f(49, 'coins', { n: 15, still: 1.0 }),
...
export function describe(cleared) {
  ...
  return {
    ...
    floors: FLOORS.map((x) => ({
      ...
      open: x.floor === done + 1      // 지금 도전할 수 있는 층
    }))
  };
}
