...
export const FLOORS = [
  ...
  f(22, 'coins', { n: 8 }),
  f(23, 'coins', { n: 10 }),
  f(24, 'coins', { n: 10, limit: 50 }),
  f(25, 'coins', { n: 12, limit: 50 }),
  f(26, 'coins', { n: 12, limit: 45 }),
  f(27, 'coins', { n: 14, limit: 45 }),
  f(28, 'coins', { n: 14, limit: 45, jumps: 25 }),
  f(29, 'coins', { n: 15, limit: 45, zone: true }),
  f(30, 'coins', { n: 18, limit: 45 }),

  // ── 31~40층: 가야 할 곳이 생긴다. 빔만 피해서는 안 되고 움직여야 한다.
  f(31, 'circuit', { n: 3, limit: 45 }),
  f(32, 'circuit', { n: 4, limit: 55 }),
  f(33, 'circuit', { n: 5, limit: 60 }),
  f(34, 'circuit', { n: 5, limit: 55, jumps: 25 }),
