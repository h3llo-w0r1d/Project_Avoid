...
export const FLOORS = [
  ...
  // ── 21~30층: 가야 할 곳이 생긴다. 빔만 피해서는 안 되고 움직여야 한다.
  f(21, 'circuit', { n: 3, limit: 45 }),
  f(22, 'circuit', { n: 4, limit: 55 }),
  f(23, 'circuit', { n: 5, limit: 60 }),
  f(24, 'circuit', { n: 5, limit: 55, jumps: 25 }),
  f(25, 'circuit', { n: 6, limit: 65 }),
  f(26, 'survive', { seconds: 30, zone: true }),
  f(27, 'survive', { seconds: 35, zone: true }),
  f(28, 'survive', { seconds: 40, zone: true }),
  f(29, 'survive', { seconds: 35, zone: true, jumps: 25 }),
  f(30, 'circuit', { n: 5, limit: 60, zone: true }),

  // ── 31~40층: 코인 수집. 빔을 피하는 것만으로는 안 되고 '가야' 한다.
  f(31, 'coins', { n: 6 }),
  f(32, 'coins', { n: 8 }),
  f(33, 'coins', { n: 10 }),
  f(34, 'coins', { n: 10, limit: 50 }),
  f(35, 'coins', { n: 12, limit: 50 }),
  f(36, 'coins', { n: 12, limit: 45 }),
  f(37, 'coins', { n: 14, limit: 45 }),
  f(38, 'coins', { n: 14, limit: 45, jumps: 25 }),
  f(39, 'coins', { n: 15, limit: 45, zone: true }),
  f(40, 'coins', { n: 18, limit: 45 }),

  // ── 41~50층: 물리 변형. 발밑 감각 자체가 달라진다.
  f(41, 'survive', { seconds: 30, phys: 'slip' }),
  f(42, 'survive', { seconds: 33, phys: 'slip' }),
  f(43, 'survive', { seconds: 36, phys: 'slip' }),
  f(44, 'survive', { seconds: 30, phys: 'heavy' }),
  f(45, 'survive', { seconds: 33, phys: 'heavy' }),
  f(46, 'survive', { seconds: 36, phys: 'heavy' }),
  f(47, 'survive', { seconds: 33, phys: 'fast' }),
  f(48, 'survive', { seconds: 36, phys: 'fast' }),
  f(49, 'survive', { seconds: 40, phys: 'fast' }),
  f(50, 'survive', { seconds: 40, phys: 'slipheavy' }),

  // ── 51~60층: 봇전. 먼저 죽으면 진다. 여기에 제약이 얹히기 시작한다.
  f(51, 'bot', { tier: 'rookie' }),
  f(52, 'bot', { tier: 'rookie', jumps: 25 }),
  f(53, 'bot', { tier: 'novice' }),
  f(54, 'bot', { tier: 'novice', phys: 'slip' }),
  f(55, 'bot', { tier: 'mid' }),
  f(56, 'bot', { tier: 'mid', jumps: 25 }),
  f(57, 'bot', { tier: 'expert' }),
  f(58, 'bot', { tier: 'expert', phys: 'heavy' }),
  f(59, 'bot', { tier: 'master' }),
  f(60, 'bot', { tier: 'godwater', jumps: 25 })
];
...
export const ZONES = [
  ...
  { from: 21, to: 30, name: '이동 규칙' },
  { from: 31, to: 40, name: '코인 수집' },
  { from: 41, to: 50, name: '물리 변형' },
  { from: 51, to: 60, name: '봇전' }
];
